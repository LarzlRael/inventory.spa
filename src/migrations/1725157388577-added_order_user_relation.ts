...
export class AddedOrderUserRelation1725157388577 implements MigrationInterface {
    name = 'AddedOrderUserRelation1725157388577'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`order\` ADD \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`);
