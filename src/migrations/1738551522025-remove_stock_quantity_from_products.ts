...
export class RemoveStockQuantityFromProducts1738551522025 implements MigrationInterface {
    name = 'RemoveStockQuantityFromProducts1738551522025'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_dcf7550e6f03fb1414ed41628f\` ON \`products\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`sell_detail\` ADD CONSTRAINT \`FK_5e8a95d64e5b56059fefa78e85e\` FOREIGN KEY (\`id_sell\`) REFERENCES \`sells\`(\`idSell\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`sell_detail\` ADD CONSTRAINT \`FK_236a83d394e727d0b8e2a004efb\` FOREIGN KEY (\`id_product\`) REFERENCES \`products\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`stockQuantity\` int NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_dcf7550e6f03fb1414ed41628f\` ON \`products\` (\`inventoryId\`)`);
    }
