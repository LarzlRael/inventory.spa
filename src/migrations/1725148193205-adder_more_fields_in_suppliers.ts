...
export class AdderMoreFieldsInSuppliers1725148193205 implements MigrationInterface {
    name = 'AdderMoreFieldsInSuppliers1725148193205'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`sells\` (\`idSell\` int NOT NULL AUTO_INCREMENT, \`sellDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`totalVenta\` int NOT NULL, \`clientName\` varchar(255) NOT NULL, \`idUsuario\` int NULL, \`idCliente\` int NULL, PRIMARY KEY (\`idSell\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`purchasePrice\` decimal(10,2) NOT NULL, \`SalePrice\` int NOT NULL, \`stockQuantity\` int NOT NULL, \`idCategory\` int NULL, \`addedBy\` int NULL, \`supplierId\` int NULL, UNIQUE INDEX \`IDX_26c9336d231c4e90419a5954bd\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
