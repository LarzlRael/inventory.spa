...
export class Migration1738456608329 implements MigrationInterface {
    name = 'Migration1738456608329'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`supplier\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`contactName\` varchar(255) NOT NULL, \`contactPhone\` varchar(255) NULL, \`address\` varchar(255) NULL, \`city\` varchar(255) NULL, \`notes\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`sells\` (\`idSell\` int NOT NULL AUTO_INCREMENT, \`sellDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`totalSale\` int NOT NULL, \`clientName\` varchar(255) NULL, \`idUsuario\` int NULL, \`idCliente\` int NULL, PRIMARY KEY (\`idSell\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`rental\` (\`idSell\` int NOT NULL AUTO_INCREMENT, \`sellDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`totalPrice\` int NOT NULL, \`clientName\` varchar(255) NULL, \`endDate\` datetime NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`idUsuario\` int NULL, \`idCliente\` int NULL, \`productId\` int NULL, PRIMARY KEY (\`idSell\`)) ENGINE=InnoDB`);
